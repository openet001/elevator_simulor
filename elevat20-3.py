...
class ElevatorSystemGUI:
    ...
    def draw_elevators(self):
        ...
        for eid, elevator in enumerate(self.elevators):
            try:
                y = elevator.current_y if hasattr(elevator, 'current_y') else 40 + self.floors.index(elevator.current_floor) * 40
            except:
                continue
            x = 60 + eid * 80
            ...
            self.canvas.create_rectangle(x+5, y-30, x+55, y+10, 
                                        ...
                                        shadowcolor=self.colors["shadow"], offset=(2, 2),
                                        tags="elevator")
